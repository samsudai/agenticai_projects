...
PERSIST_PATH = r"c:/code/agenticai/agenticai-main/15_real/local_chroma_insurance_db"
PDF_PATH = r"c:/code/agenticai/agenticai-main/15_real/Introduction_to_Insurance.pdf"
